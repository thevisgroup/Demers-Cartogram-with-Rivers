...
\new{See \ref{dataset} for a detailed description of the datasets used.}
...
\footnotetext{The materials for P1-P4 are available on the Open Science Foundation website at \url{https://osf.io/q39w7}.}
