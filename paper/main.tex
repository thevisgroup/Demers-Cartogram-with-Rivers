\documentclass[iicol,sn-basic]{sn-jnl}% Basic Springer 
...
\newcommand{\thumbnail}[2]{
    \begin{samepage}
      ...
      \begin{wrapfigure}{r}{0.4\columnwidth}
        \vspace{-15pt}
        \begin{center}
          \includegraphics[width=0.38\columnwidth]{figure/"#1".png}
        \end{center}
      \end{wrapfigure}
      #2
...
\author*[1]{\fnm{Qiru} \sur{Wang}}\email{qiru.wang1@nottingham.ac.uk}

\author[1]{\fnm{Kai} \sur{Xu}}\email{kai.xu@nottingham.ac.uk}
\equalcont{These authors contributed equally to this work.}

\author[1]{\fnm{Robert} \sur{Laramee}}\email{robert.laramee@nottingham.ac.uk}
\equalcont{These authors contributed equally to this work.}

\affil[1]{\orgdiv{School of Computer Science}, \orgname{University of Nottingham}, \orgaddress{\street{University Park}, \city{Nottingham}, \postcode{NG7 2RD}, \state{England}, \country{United Kingdom}}}
...

{
    \begin{figure}[tb!]
        \centering
        \includegraphics[width=0.8\columnwidth,keepaspectratio]{figure/river_resolution.png}
...
Similarly, increasing the resolution of rivers, at the expense of the speed of node-river intersection test, may produce a layout with higher legibility.

    {
        \begin{figure*}[tb!]
            \centering
            \includegraphics[width=0.9\textwidth,keepaspectratio]{figure/UI.png}
...
See \Cref{fig:task} for an example.

    {
        \begin{figure}[tb!]
            \centering
            \includegraphics[width=\columnwidth,keepaspectratio]{figure/task.png}
...
\begin{figure}[b!]
    \centering
    \includegraphics[width=\columnwidth,keepaspectratio]{figure/accuracy.png}
...
However, the average time to locate a given CCG is reduced for 3 out of the 4 CCGs users in the study.

    {
        \begin{figure}[t!]
            \centering
            \includegraphics[width=\columnwidth,keepaspectratio]{figure/rt.png}
...
\begin{figure}[tb!]
    \centering
    \includegraphics[width=\columnwidth,keepaspectratio]{figure/likert.png}
...
See \Cref{fig:extreme} for an example. We plan to explore the impact of different color maps on the legibility of cartograms in future work.

    {
        \begin{figure}[tb!]
            \centering
            \includegraphics[width=0.8\columnwidth,keepaspectratio]{figure/extreme.png}
...
\begin{appendices}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\columnwidth]{figure/import_rivers.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\columnwidth]{figure/import_ccgs.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\columnwidth]{figure/unify_crs.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\columnwidth]{figure/export_rivers.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\columnwidth]{figure/export_ccgs.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\columnwidth]{figure/export_topojson.png}
    ...
    The reduction in file size is significant and greatly reduces the initialization time of our implementation. See \Cref{table:pre-processing_result}.
