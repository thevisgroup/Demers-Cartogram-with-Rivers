...
135 CGGs are rendered on the screen as a choropleth on the left. We then generated another view on the right using cartograms. The color in both visual designs is mapped to the dataset. See \Cref{fig:task} for an example.
...
The materials for P1-P4 are available at \URL{https://osf.io/q39w7}.
