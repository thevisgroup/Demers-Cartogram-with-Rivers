    ...
    \begin{algorithmic}[1]
        ...
        \While{$ \nodeSize < \nodeSizeMax $}
            ...
            \While{$ \nodeListCross = True $}
                ...
                \State \Comment{We should merge two lists into one}
