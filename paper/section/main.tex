\section{Cartograms with Dynamic Features}
...

 {
  \begin{figure*}[tb!]
      ...
      \caption{A flowchart illustration of our layout algorithm.See \figref{fig:flowchart-stalemate} for the flow of processing stalemate. See also \algoref{alg:UpdateLayout} for more detail.}
      \label{fig:flowchart}
  \end{figure*}
