...
While we focus on rectangular and Dorling cartograms in this paper, we provide brief definitions of contiguous and non-contiguous cartograms for interested readers: Contiguous cartograms are topology-preserving that maintain connectivity with their adjacent neighbors but have distortion in shape. Non-contiguous cartograms sacrifice the topological connectivity with neighbors to enable growing or shrinking in size while maintaining their original shape \cite{dent2009Cartography}.

\citea{nusrat2016State} define and summarize three major accuracy dimensions for cartograms: statistical, geographical, and topological. Each cartogram design may make accuracy trade-offs between dimensions. We provide an overview of these cartograms in Table \ref{table:accuracy}.
...
Our work extends Demers cartograms. We introduce dynamic topological feature, a river, aiming to improve the interpretation, readability, and geographical accuracy.