...
We first obtained a relation ID for the shapefile from OpenStreetMap, then downloaded the entire shapefile via a query (See Listing~\ref{overpass}) through Overpass Turbo \cite{overpassturboOverpass}.
