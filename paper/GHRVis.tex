...
\parbox{\textwidth}{\centering School of Computer Science, University of Nottingham, UK \\ \begin{center}
    \centering
    \includegraphics[height=3cm,keepaspectratio]{figure/cover.png}
    \captionof{figure}{The River Thames passing through NHS Clinical Commissioning Groups in London and surrounding areas.}
\end{center}
}
}
