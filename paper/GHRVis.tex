...
\parbox{\textwidth}{\centering Affiliation \\ \begin{center}
        ...
        \captionof{figure}{The River Thames passing through a cartographic representation of the NHS Clinical Commissioning Groups in London and surrounding areas.}
    \end{center}
}
}
